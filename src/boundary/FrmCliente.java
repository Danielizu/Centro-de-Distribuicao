...
public class FrmCliente extends JFrame {
	...
	public void labelsMsgErro() {
		...
		lblCPFInvalido = new JLabel("CPF Inv·lido!");
	...
	// Metodo que valida o tipo de cliente e se a informacao È valida
	...
	public void excluirCaracteresEspeciais() {
		...
		txtNomeCompleto.addKeyListener(new KeyAdapter() {
			public void keyTyped(KeyEvent arg0) {
				String caracteres = "0987654321Éäåéöúûü¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷ÿŸ⁄€‹›ﬁﬂ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔÒÚÛÙıˆ¯˘˙˚¸˝˛ˇ/|.!?@#$%®&*(){}][¥¥;";
		...
		txtRazaoSocial.addKeyListener(new KeyAdapter() {
			public void keyTyped(KeyEvent arg0) {
				String caracteres = "Éäåéöúûü¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷ÿŸ⁄€‹›ﬁﬂ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔÒÚÛÙıˆ¯˘˙˚¸˝˛ˇ/|.!?@#$%®&*(){}][¥¥;";
				if (caracteres.contains(arg0.getKeyChar() + "")) {
					arg0.consume();
				}
			}
